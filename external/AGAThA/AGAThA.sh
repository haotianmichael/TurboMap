#!/bin/bash
MAIN_DIR="/home/nfs/mahaotian/CUDA/AGAThA/"                  #the main directory
...
python3 /home/nfs/mahaotian/CUDA/AGAThA/misc/avg_time.py $PROCESS $DATASET_NAME ${RAW_FILE} ${FINAL_FILE} $ITER 
